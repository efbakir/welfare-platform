  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa] p-4">
      ...
      <div
        className={
          inOnboarding
            ? "ml-[5.25rem] min-h-[calc(100vh-2rem)] rounded-2xl bg-[#f7f8fa] p-2 transition-all duration-300 peer-hover:ml-[15.5rem]"
            : "ml-[calc(5.25rem+var(--sidebar-w)+1rem)] min-h-[calc(100vh-2rem)] rounded-2xl bg-[#f7f8fa] p-2 transition-all duration-300 peer-hover:ml-[calc(15.5rem+var(--sidebar-w)+1rem)]"
        }
      >
        {!inOnboarding && (
