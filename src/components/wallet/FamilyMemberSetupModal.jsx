...
export default function FamilyMemberSetupModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-slate-900/45 p-4 backdrop-blur-sm">
      <div className="w-full max-w-lg rounded-xl border border-border bg-surface shadow-[var(--shadow-hover)]">
        ...
        <div className="space-y-4 p-6">
          <div>
            ...
            <input
              ...
              className="w-full rounded-md border border-border bg-surface px-4 py-2.5 text-sm text-text-primary outline-none transition focus:border-blue"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="h-2 w-full cursor-pointer appearance-none rounded-sm bg-[#e6ebf2]"
            />
